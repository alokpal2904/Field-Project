      ...
      >
        <div className="layout-container flex h-full grow flex-col">
          <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#e7eef4] px-4 py-3">
            <div className="flex items-center gap-34 text-[#0d151c]">
            ...
            <div className="flex flex-1 justify-end gap-8">
              ...
              <Link to="/" className="text-[#0d151c] text-sm font-medium leading-normal">
              Home
            </Link>
                <Link to="/about" className="text-[#0d151c] text-sm font-medium leading-normal">
              About
            </Link>
                <Link to="/activities" className="text-[#0d151c] text-sm font-medium leading-normal">
              Activities
            </Link>
                <Link to="/gymkhana" className="text-[#0d151c] text-sm font-medium leading-normal">
              Gymkhana
            </Link>
                <Link to="/events" className="text-[#0d151c] text-sm font-medium leading-normal">
              Events
            </Link>
                <Link to="/library" className="text-[#0d151c] text-sm font-medium leading-normal">
              Library
            </Link>
                <Link to="/contact" className="text-[#0d151c] text-sm font-medium leading-normal">
              Contact
            </Link>
                {isLoggedIn ? (
                  <button
                    onClick={handleLogout}
                    className="bg-[#2094f3] text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-[#1a7bc2] transition-colors duration-200"
                  >
                    Logout
                  </button>
                ) : (
                ...
                <div className="p-4">
                  <div
                    ...
                    style={{
                      ...
                      minHeight: isLoggedIn ? '600px' : '480px',
                  ...
                  >
                    <div className="flex flex-col gap-4 text-left max-w-2xl mt-16">
                      <h1 className="text-white text-5xl font-black leading-tight tracking-[-0.033em] @[480px]:text-6xl @[480px]:font-black @[480px]:leading-tight @[480px]:tracking-[-0.033em] drop-shadow-lg">
                        Welcome to Sindhu Youth Circle
                      </h1>
                      <h2 className="text-white text-lg font-normal leading-relaxed @[480px]:text-xl @[480px]:font-normal @[480px]:leading-relaxed drop-shadow-md">
